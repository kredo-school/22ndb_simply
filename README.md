...
##### 1. Clone repository
```
$ git clone git@github.com:kredo-school/22ndb_simply.git
```
...
##### Name: localhost/22ndb_simply
##### HOST: localhost
##### USERNAME: root
##### PASSWORD:     
##### DATABASE: 22ndb_simply
##### PORT: 3306
