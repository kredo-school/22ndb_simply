...
<div class="conatiner">
    <div class="row">
        <div class="col">
            <div class="col d-flex flex-column justify-content-center get-item-spacing">                
                ...
                <p class="text-danger line-height2">&emsp;Please include "Donation ID" <br>&emsp;when sending a message to the <br>&emsp;owner for the first time.</p>
            </div>
